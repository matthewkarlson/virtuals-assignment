...
export const CONTRACT_ADDRESSES = {
  EasyV: process.env.NEXT_PUBLIC_EASYV_ADDRESS || "0x06Af5812D823ea208833A9aFBf207396714bc031",
  AgentFactory: process.env.NEXT_PUBLIC_AGENT_FACTORY_ADDRESS || "0x39F26E0D5F7f603be61175E50A21895a4d8Da989",
  BondingContract: process.env.NEXT_PUBLIC_BONDING_ADDRESS || "0xa7E99C1df635d13d61F7c81eCe571cc952E64526",
} as const;
